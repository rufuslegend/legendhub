	...
	'<div class="collapse navbar-collapse" id="navbarSupportedContent">' +
		...
		'<ul class="navbar-nav ml-auto">' +
			...
			'<li class="nav-item dropdown float-right">' +
                '<button type="button" class="nav-link dropdown-toggle dropdown-toggle-no-caret border-0 bg-transparent" id="themeDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Choose theme">' +
